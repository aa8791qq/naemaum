...
<body>
	...
	<form method="get" action="req">
		...
		<input type="hidden" name="hidden1" value = "hidden11">
		...
		<input type ="checkbox" name ="checkbox1" value = "checkbox11">체크박스1
		<input type ="checkbox" name ="checkbox1" value = "checkbox22">체크박스2
		<input type ="checkbox" name ="checkbox1" value = "checkbox33">체크박스3<br>
		...
		<select name = "select1" value = "select11">
			...
			<option value = "option1"> 옵션2 </option>
			<option value = "option1"> 옵션3 </option>
		</select>		
